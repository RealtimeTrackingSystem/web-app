...
export class NavbarComponent implements OnInit {
  ...
  @Input() hostMemberships: IHostMemberships[];
  @Input() activeHost: IHostMemberships;
  ...
  ngOnInit() {
    ...
    console.log(this.hostMemberships);
  }
  onResize(event) {
    if ($(window).width() > 991) {
      return false;
  ...
  changeHost (hostMembership: IHostMemberships) {
    this.setHost.emit(hostMembership);
  }
}
